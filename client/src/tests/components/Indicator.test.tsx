...
describe('<Indicator currentValue: number = {yourValue} /> - Adding light which depends on the changing of currentValue', () => {
    test('Indicator has only 1 class', () => {
        const { container } = render(<Indicator currentValue={100} />);
    ...
    test('Indicator value can be changed', () => {
        const { container, rerender } = render(<Indicator currentValue={100} />);
        rerender(<Indicator currentValue={200} />);
    ...
    test('Indicator can properly indicate receiving lower values (style changing)', () => {
        const { container, rerender } = render(<Indicator currentValue={100} />);
        rerender(<Indicator currentValue={50} />);
        expect(container.getElementsByClassName('indicator')[0]).toHaveStyle(
